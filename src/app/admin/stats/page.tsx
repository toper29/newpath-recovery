        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="bg-[#0A0F1F] border border-primary/20 rounded-2xl p-5">
                    ...
                    <p className="text-3xl font-black">{stats.mainStats.totalUsers.toLocaleString()}</p>
                </div>
                <div className="bg-[#0A0F1F] border border-primary/20 rounded-2xl p-5">
                    <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-3xl font-black text-accent">{stats.mainStats.activeUsersToday}</p>
                </div>
                <div className="bg-[#0A0F1F] border border-primary/20 rounded-2xl p-5">
                    <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-3xl font-black text-blue-500">+{stats.mainStats.newUsersWeekly}</p>
                </div>
                <div className="bg-[#0A0F1F] border border-primary/20 rounded-2xl p-5">
                    <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-3xl font-black text-orange-500">{stats.mainStats.avgAddictionScore}<span className="text-sm font-normal text-foreground/50">%</span></p>
                </div>
            </div>
                ...
                <div className="bg-[#0A0F1F] border border-primary/20 rounded-2xl p-6">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center justify-between p-3 rounded-xl border border-red-500/20 bg-red-500/5">
                            ...
                            <span className="font-bold text-red-500">{stats.distribution.high}% Users</span>
                        </div>
                        <div className="flex items-center justify-between p-3 rounded-xl border border-orange-500/20 bg-orange-500/5">
                            ...
                            <span className="font-bold text-orange-500">{stats.distribution.medium}% Users</span>
                        </div>
                        <div className="flex items-center justify-between p-3 rounded-xl border border-accent/20 bg-accent/5">
                            ...
                            <span className="font-bold text-accent">{stats.distribution.low}% Users</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-[#0A0F1F] border border-primary/20 rounded-2xl p-6 h-64 flex flex-col">
                ...
                <div className="flex-1 border border-primary/10 rounded-xl bg-background/50 flex flex-col items-center justify-center relative overflow-hidden">
                    ...
                    <div className="flex items-end gap-2 h-24 z-10 opacity-60">
                        <div className="w-16 bg-accent h-full rounded-t flex items-end justify-center pb-2 text-[9px] font-bold text-background" style={{ height: '100%' }}>D1: {stats.funnel.day1}</div>
                        <div className="w-16 bg-accent/80 rounded-t flex items-end justify-center pb-2 text-[9px] font-bold text-background" style={{ height: `${(stats.funnel.day7 / Math.max(stats.funnel.day1, 1)) * 100}%` }}>D7: {stats.funnel.day7}</div>
                        <div className="w-16 bg-blue-500 rounded-t flex items-end justify-center pb-2 text-[9px] font-bold text-white" style={{ height: `${(stats.funnel.day11 / Math.max(stats.funnel.day1, 1)) * 100}%` }}>D11: {stats.funnel.day11}</div>
                        <div className="w-16 bg-red-500 rounded-t flex items-end justify-center pb-2 text-[9px] font-bold text-white" style={{ height: `${(stats.funnel.day14 / Math.max(stats.funnel.day1, 1)) * 100}%` }}>D14: {stats.funnel.day14}</div>
                    </div>
                </div>
            </div>
        </div>
