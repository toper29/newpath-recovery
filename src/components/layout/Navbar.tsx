...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 w-full border-b border-primary/20 bg-background/80 backdrop-blur-md z-[100]">
            ...
            {/* Mobile Menu Overlay */}
            {isMenuOpen && (
                <div className="md:hidden fixed inset-0 top-20 bg-background z-[90] animate-in fade-in slide-in-from-right-4 duration-300">
                    <div className="flex flex-col p-8 gap-6 items-center justify-center h-[calc(100vh-5rem)]">
